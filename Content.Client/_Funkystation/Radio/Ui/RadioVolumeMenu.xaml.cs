...
public sealed partial class RadioVolumeMenu : FancyWindow
{
    ...
    private const float SliderWidth = 280; // need to figure out a way to get this dynamically
    ...
    public void UpdateLabels(Entity<RadioMicrophoneComponent> micEntity)
    {
        ...
        // if the max isnt specified, don't create the number labels
        if (micEntity.Comp.MaxRange == null)
        {
        ...
        for (var i = min; i <= max; i++)
        {
            ...
            label.Margin =
                new Thickness(0, 0, SliderWidth / (max - min) - 19, 0); // TODO: need to figure out a way to get that subtract value dynamically
