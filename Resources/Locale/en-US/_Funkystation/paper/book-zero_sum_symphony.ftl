book-text-zerosumsymphony-1 = [head=2]The Zero-Sum Symphony[/head][head=3]
      Book One: Phantom Breach[/head]
...
book-text-zerosumsymphony-2 = [head=2]The Zero-Sum Symphony[/head][head=3]
      Book Two: The Omega Stratagem[/head]
      A book by Genevieve Blaine
