book-text-onchangelings = [head=1][color=MediumOrchid]On Changelings[/color][/head][head=1][/head]
      Written by TSBTS[mono]
      ...
      However, the changeling trope arose due to the infamous 2509 case, NT v. Cybersun. It originally concluded that all Syndicate mentions or supposed recordings were legal grounds for libel and subsequent legal action.[color=Gray][italic]

      Thankfully due to the Supreme Space Court overturning session in the Frontier Hypatia sector, this no longer applies to fictional literature, cinema, and theory.[/italic][/color]
